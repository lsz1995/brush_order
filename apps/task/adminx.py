...
class LogisticsTaskAdmin(object):
    list_display = ['user','receive_name','mobile','province','city','district','address','postal_code','state','add_time']  # 后台管理显示地段
    # search_fields = ['Permissions','is_download','note']   # 后台搜索字段
    list_filter =  ['user','receive_name','mobile','province','city','district','address','postal_code','state','add_time']
